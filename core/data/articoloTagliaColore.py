...
t_articolo_taglia_colore = Table('articolo_taglia_colore', params['metadata'],
            ...
            Column('id_stagione',Integer,ForeignKey(fk_prefix_main+'stagione_abbigliamento.id',onupdate="CASCADE",ondelete="CASCADE")),
            Column('id_genere',Integer,ForeignKey(fk_prefix_main+'genere_abbigliamento.id',onupdate="CASCADE",ondelete="CASCADE")),
